...
public sealed class UpdateService : IDisposable
{
    ...
    /// <summary>
    /// Deselects packages and deletes their copies, which is the space-reclaiming action. A copy that ships
    /// inside the program is deleted like any other: the player owns the disk, and the region comes back by
    /// being downloaded again. Closing the program is what makes a shipped copy reappear.
    /// </summary>
