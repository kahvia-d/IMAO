...
public sealed partial class CoreHostService : ObservableObject, IAsyncDisposable
{
    ...
    public async Task<bool> ConfigureAsync(int? captureWay = null, int? overlayPresentMode = null,
        ...
        bool? statusBarEnabled = null, bool? mapStatusBarEnabled = null, bool? statusBallEnabled = null,
        CancellationToken cancellationToken = default,
        int? nearestCompletionKey = null, int? manualRouteKey = null, int? currentTargetGuideKey = null,
        int? guideSkipKey = null,
        ...
        try
        {
            ...
            try
            {
                next = configuration.Update(old => old with
                {
                    ...
                    MapStatusBarEnabled = mapStatusBarEnabled ?? old.MapStatusBarEnabled,
                    StatusBallEnabled = statusBallEnabled ?? old.StatusBallEnabled,
                    ...
                    GuideSkipKey = guideSkipKey ?? old.GuideSkipKey,
